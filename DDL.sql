...
CREATE TABLE Serpente(
  ...
  Stato ENUM(“In vendita”, “Venduto”, “In adozione”, “Adottato”, “Non in vendita”, “Morto”, “Riproduttore”) DEFAULT “Non in vendita” NOT NULL,
  ...
  PRIMARY KEY (ID),
  CONSTRAINT FKSerpente_IVAAllevamento FOREIGN KEY (IVAAllevamento) REFERENCES Allevamento(IVA)
  ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT FKSerpente_CFCliente FOREIGN KEY (CFCliente) REFERENCES Cliente(CF)
  ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT FKSerpente_NomeSpecie FOREIGN KEY (NomeSpecie) REFERENCES Specie(NomeScientifico)
  ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE BrumazioneIndotta(
  ...
  CONSTRAINT FKBrumazioneIndotta_IDSerpente FOREIGN KEY (IDSerpente) REFERENCES Serpente(ID)
  ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE Telefono(
  ...
  PRIMARY KEY (Numero),
  CONSTRAINT FKTelefono_IVAAllevamento FOREIGN KEY (IVAAllevamento) REFERENCES Allevamento(IVA)
  ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT FKTelefono_IVAClinica FOREIGN KEY (IVAClinica) REFERENCES Clinica(IVA)
  ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE Visita(
  ...
  PRIMARY KEY (Numero),
  CONSTRAINT FKVisita_IDSerpente FOREIGN KEY (IDSerpente) REFERENCES Serpente(ID)
  ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT FKVisita_IVAClinica FOREIGN KEY (IVAClinica) REFERENCES Clinica(IVA)
  ON DELETE SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE Pasti(
  ...
  CONSTRAINT FKPasti_IDSerpente FOREIGN KEY (IDSerpente) REFERENCES Serpente(ID)
  ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT FKPasti_NomeCibo FOREIGN KEY (NomeCibo) REFERENCES Cibo(Nome)
...
CREATE TABLE Progenie(
  ...
  PRIMARY KEY (Data, IDSerpente),
  CONSTRAINT FKProgenie_IDSerpente FOREIGN KEY (IDSerpente) REFERENCES Serpente(ID)
  ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE Incubazione(
  ...
  CONSTRAINT FKIncubazione_Progenie FOREIGN KEY (DataParto, IDSerpente)
  REFERENCES Progenie(Data, IDSerpente)
  ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE Specie(
  ...
  Alimentazione ENUM(“Roditori”, “Piccoli Mammiferi”, “Pesci”, “Uova”, “Vermi”) DEFAULT “Roditori” NOT NULL,
  Attivita ENUM(“Diurno”, “Notturno”, “Crepuscolare”) DEFAULT “Crepuscolare” NOT NULL,
  Difesa ENUM(“Morso”, “Veleno”, “Tanatosi”, “Intimidazione”, “Musk”, “Avviluppamento”) DEFAULT “Morso” NOT NULL,
  ...
  CONSTRAINT FKSpecie_IDTerrario FOREIGN KEY (IDTerrario) REFERENCES Terrario(ID)
  ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE Brumazione(
  ...
  MeseInizio ENUM(“Gen”, “Feb”, “Mar”, “Apr”, “Mag”, “Giu”, “Lug”, “Ago”, “Set”, “Ott”, “Nov”, “Dic”) NOT NULL,
  MeseFine ENUM(“Gen”, “Feb”, “Mar”, “Apr”, “Mag”, “Giu”, “Lug”, “Ago”, “Set”, “Ott”, “Nov”, “Dic”) NOT NULL,
  TempMedia TINYINT UNSIGNED NOT NULL,

  PRIMARY KEY (NomeSpecie),
  CONSTRAINT FKBrumazione_NomeSpecie FOREIGN KEY (NomeSpecie) REFERENCES Specie(NomeScientifico)
  ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE Eta(
  ...
  CONSTRAINT FKEta_NomeSpecie FOREIGN KEY (NomeSpecie) REFERENCES Specie(NomeScientifico)
  ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT FKEta_IDTerrario FOREIGN KEY (IDTerrario) REFERENCES Terrario(ID)
  ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE Accoppiamento(
  ...
  CONSTRAINT FKAccoppiamento_IDSerpenteM FOREIGN KEY (IDSerpenteM) REFERENCES Serpente(ID)
  ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT FKAccoppiamento_IDSerpenteF FOREIGN KEY (IDSerpenteF) REFERENCES Serpente(ID)
  ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE Parentela(
  ...
  CONSTRAINT FKParentela_IDGenitore FOREIGN KEY (IDGenitore) REFERENCES Serpente(ID)
  ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT FKParentela_IDFiglio FOREIGN KEY (IDFiglio) REFERENCES Serpente(ID)
  ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE PH(
  ...
  CONSTRAINT FKPH_IDSerpente FOREIGN KEY (IDSerpente) REFERENCES Serpente(ID)
  ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT FKPH_IDMorph FOREIGN KEY (IDMorph) REFERENCES Morph(ID)
  ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE Aspetto(
  ...
  PRIMARY KEY (IDSerpente, IDMorph),
  CONSTRAINT FKAspetto_IDSerpente FOREIGN KEY (IDSerpente) REFERENCES Serpente(ID)
  ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT FKAspetto_IDMorph FOREIGN KEY (IDMorph) REFERENCES Morph(ID)
  ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE Composto(
  ...
  CONSTRAINT FKComposto_IDComponente FOREIGN KEY (IDComponente) REFERENCES Morph(ID)
  ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT FKComposto_IDRisultato FOREIGN KEY (IDRisultato) REFERENCES Morph(ID)
  ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE Causa(
  ...
  CONSTRAINT FKCausa_IDMorph FOREIGN KEY (IDMorph) REFERENCES Morph(ID)
  ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT FKCausa_Allele FOREIGN KEY (NomeAllele, LocusAllele) REFERENCES Allele(Nome, Locus)
  ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE Genetica(
  ...
  CONSTRAINT FKGenetica_IDMorph FOREIGN KEY (IDMorph) REFERENCES Morph(ID)
  ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT FKGenetica_NomeSpecie FOREIGN KEY (NomeSpecie) REFERENCES Specie(NomeScientifico)
  ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE TerrenoBrum(
  ...
  CONSTRAINT FKTerrenoBrum_NomeSpecie FOREIGN KEY (NomeSpecie)
  REFERENCES Specie(NomeScientifico)
  ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT FKTerrenoBrum_NomeSubstrato FOREIGN KEY (NomeSubstrato)
  REFERENCES Substrato(NomeSub)
  ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE Terreno(
  ...
  CONSTRAINT FKTerreno_IDTerrario FOREIGN KEY (IDTerrario) REFERENCES Terrario(ID)
  ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT FKTerreno_NomeSubstrato FOREIGN KEY (NomeSubstrato) REFERENCES Substrato(NomeSub)
  ON DELETE CASCADE ON UPDATE CASCADE
);